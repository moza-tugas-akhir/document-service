...
export async function appendResCreateDoc(resTime) {
  const folderPath = path.join(__dirname, 'response-times-ipfs');
  const filePath = path.join(folderPath, 'ipfs_upload_times.txt');
...
export async function appendResQueryUserId(resTime) {
  const folderPath = path.join(__dirname, 'response-times-ipfs');
  const filePath = path.join(folderPath, 'ipfs_q_userId_times.txt');
...
export async function appendResQueryDocId(resTime) {
  const folderPath = path.join(__dirname, 'response-times-ipfs');
  const filePath = path.join(folderPath, 'ipfs_q_docId_times.txt');
